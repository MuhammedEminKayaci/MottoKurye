          ...
          <div className="bg-white rounded-2xl shadow-xl border-2 border-neutral-200 p-8 md:p-12 space-y-8">
            ...
            <section>
              ...
              <div className="space-y-3 text-neutral-700 leading-relaxed">
                ...
                <ul className="list-disc list-inside ml-4 space-y-2">
                  ...
                  <li><strong>İletişim:</strong> <Link href="/iletisim" className="text-[#ff7a00] underline hover:text-[#ff6a00]">İletişim sayfamızdan</Link> veya info@paketservisci.com adresine yazarak</li>
                </ul>
                <p>
            ...
            <section>
              ...
              <div className="space-y-3 text-neutral-700 leading-relaxed">
                ...
                <ul className="list-disc list-inside ml-4 space-y-1">
                  <li>Bizimle iletişime geçebilirsiniz: info@paketservisci.com</li>
