          ...
          <div className="bg-white rounded-2xl shadow-xl border-2 border-neutral-200 p-8 md:p-12 space-y-8">
            ...
            <section>
              ...
              <div className="space-y-3 text-neutral-700 leading-relaxed">
                ...
                <p>
                  <strong>1.3.</strong> Platform üzerinden sunulan hizmetler, kuryeler ile işletmeler arasında iletişim kurmayı kolaylaştırmak amacıyla sağlanmaktadır. PaketServisci, taraflar arasında yapılan sözleşmelerde taraf değildir ve bu ilişkilerden doğan sorumluluğu kabul etmez.
                </p>
                <p>
