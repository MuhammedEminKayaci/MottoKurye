...
interface ContactButtonsProps {
  ...
  name: string;
  role: "kurye" | "isletme";
  contactPreference?: "phone" | "in_app" | null;
}

export function ContactButtons({ phone, name, role, contactPreference }: ContactButtonsProps) {
  ...
  // If contactPreference is "in_app", don't show phone contact buttons
  ...
  // Default: "phone" option shows both WhatsApp and Phone buttons
  return (
