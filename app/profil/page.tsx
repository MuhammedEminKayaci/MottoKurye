...
export default function ProfilPage() {
  ...
  return (
    <main className="min-h-dvh w-full bg-neutral-50">
      ...
      {/* Pre-launch Bilgilendirme Banner */}
      <div className="bg-gradient-to-r from-[#ff7a00]/10 to-orange-50 border-b border-[#ff7a00]/20">
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-[#ff7a00]/15 flex items-center justify-center flex-shrink-0">
            ...
            <div>
              ...
              <p className="text-xs text-neutral-500 mt-0.5">
                Uygulamamız en kısa sürede hizmete açılacaktır. Öncelikli kullanıcılar arasında yerinizi aldınız.
              </p>
            </div>
          </div>
        </div>
