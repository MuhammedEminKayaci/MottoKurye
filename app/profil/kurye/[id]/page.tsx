...
export default async function KuryeProfilPage({ params }: CourierProfileProps) {
  ...
  const infoCards = [
    ...
    { label: 'Konum', value: courier.province && courier.district ? `${courier.province} / ${courier.district}` : (courier.province || courier.district || '-'), icon: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z' },
        ...
        {courier.phone && (
          <div className="mt-8 bg-gradient-to-r from-orange-50 to-orange-100 rounded-2xl border border-orange-200 p-6 sm:p-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <a
                href={`https://wa.me/${courier.phone.replace(/\D/g, '')}?text=${encodeURIComponent(`Merhaba ${fullName}, ilanınız hakkında bilgi almak istiyorum.`)}`}
                target="_blank"
              ...
              <a
                ...
                className="flex-1 flex items-center justify-center gap-2 py-3 px-6 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-semibold rounded-xl shadow-md hover:shadow-lg transition-all"
              >
