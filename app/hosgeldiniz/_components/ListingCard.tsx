        ...
        <div className="border-t border-neutral-200 bg-neutral-50/50 p-3 flex gap-2">
          {isGuest ? (
            ...
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 py-2.5 px-4 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white text-sm font-semibold rounded-xl border border-blue-200 shadow-sm hover:shadow-md transition-all"
            >
            ...
            // Her ikisi de seçili - telefon ve uygulama içi mesaj
            phone ? (
              <>
                <button
            ...
            // Sadece telefon seçili - WhatsApp ve Ara butonları
            <>
              <button
                onClick={handleWhatsApp}
                className="flex-1 flex items-center justify-center gap-2 py-2.5 px-4 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white text-sm font-semibold rounded-xl shadow-sm hover:shadow-md transition-all"
